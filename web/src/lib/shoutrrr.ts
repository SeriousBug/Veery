...
export const SERVICES: ServiceSpec[] = [
  ...
  },
  {
    ...
    docs: DOCS("slack"),
    fields: [
      { name: "tokenA", label: "Token A", slot: "host", required: true, secret: true },
      { name: "tokenB", label: "Token B", slot: "path1", required: true, secret: true },
      { name: "tokenC", label: "Token C", slot: "path2", required: true, secret: true },
      { name: "botname", label: "Bot name", slot: "user", advanced: true },
