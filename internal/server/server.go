...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("POST /api/containers/{id}/check-update", s.requireAuth(s.handleCheckContainerUpdate))
	s.mux.HandleFunc("POST /api/stacks/{id}/check-update", s.requireAuth(s.handleCheckStackUpdate))
	s.mux.HandleFunc("POST /api/updates/check", s.requireAuth(s.handleCheckAllUpdates))
